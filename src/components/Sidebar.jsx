    ...
    <div
      ...
      <div className="pb-5">
        <div className="flex justify-between items-center">
          ...
          <span>Chat Box</span>
          <div className="relativ py-2 group">
            <img
              src={assets.menuIcon}
              alt="menu"
        ...
        <div className="bg-[#282142] rounded-full flex items-center gap-2 py-3 px-4 mt-5">
           <img src={assets.searchIcon} alt="search" className="w-3"/> 
      ...
      <div className="flex flex-col">
        {userData.map((user,index)=>{
           return <div onClick={()=> {setSelectedUser(user)}} key={index} className={`relative flex items-center gap-2 p-2 pl-4 rounded cursor-pointer max-sm:text-sm ${selectedUser?._id === user._id && "bg-[#282142]/50"}`}>
                <img src={user?.profilePic || assets.avatarIcon} alt="" className="w-[35px] aspect-square rounded-full" />
